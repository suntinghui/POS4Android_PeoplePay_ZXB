...
public class BaseActivity extends Activity {
	...
	public static final int PROGRESS_DIALOG_NO_CANCEL 	= 10; // 带滚动条的提示框
	...
	protected Dialog onCreateDialog(int id) {
		...
		case PROGRESS_DIALOG_NO_CANCEL:
	...
	public void showProgressDialog(boolean canCancel) {
		try {
			...
			this.createProgressDialog(canCancel);
	...
	private void createProgressDialog(boolean canCancel) {
