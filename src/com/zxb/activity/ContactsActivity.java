...
public class ContactsActivity extends BaseActivity implements OnClickListener, OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
		...
		if (null == number || "".equals(number)){
			Toast.makeText(this, this.getResources().getString(R.string.contacts_prompt), Toast.LENGTH_SHORT).show();
		} else if (!number.matches("^(1(([35][0-9])|(47)|[8][01236789]))\\d{8}$")){
			Toast.makeText(this, this.getResources().getString(R.string.contacts_prompt_phone_illeg), Toast.LENGTH_SHORT).show();
		} else {
    ...
    class GetContactTask extends AsyncTask<Object, Object, Object>{
		...
		protected void onPreExecute() {
			ContactsActivity.this.showDialog(PROGRESS_DIALOG, ContactsActivity.this.getResources().getString(R.string.contacts_querying));
		}
